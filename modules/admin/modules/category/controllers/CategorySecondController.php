...
class CategorySecondController extends Controller
{
    ...
    /**
     * Lists all CategorySecond models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new CategorySecondSearch();
    ...
    /**
     * Creates a new CategorySecond model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new CategorySecond();
    ...
    /**
     * Updates an existing CategorySecond model.
    ...
    /**
     * Deletes an existing CategorySecond model.
